function Add-CrossShapeLine {
    ...
    .DESCRIPTION
        The Add-CrossShapeLine function creates a cross-shaped (plus sign) line object within a diagram, using configurable node names and visual properties.
