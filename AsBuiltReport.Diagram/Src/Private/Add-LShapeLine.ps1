function Add-LShapeLine {
    ...
    .DESCRIPTION
        The Add-LShapeLine function creates an L-shaped connector for use in diagram generation, such as with Graphviz or similar tools.
    ...
    .EXAMPLE
        Add-LShapeLine -LShapeUp "Start" -LShapeDown "Corner" -LShapeRight "End" -Arrowhead "normal" -LineStyle "dashed" -LineColor "blue"
