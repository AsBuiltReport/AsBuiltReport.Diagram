function Add-NodeEdge {
    <#
    .SYNOPSIS
        Adds a customizable directed edge between two nodes in a Graphviz diagram.

    .DESCRIPTION
        The Add-NodeEdge function creates a directed edge between two specified nodes in a Graphviz diagram.
    ...
    .EXAMPLE
        Add-NodeEdge -From 'NodeA' -To 'NodeB'

        Creates a simple directed edge from NodeA to NodeB with default attributes (solid black line, normal arrowhead).

    .EXAMPLE
        Add-NodeEdge -From 'NodeA' -To 'NodeB' -EdgeStyle 'dashed' -EdgeColor '#FF0000' -EdgeThickness 2 -Arrowhead 'vee' -EdgeLabel 'Connection'
    ...
    .EXAMPLE
        ...
        Add-NodeEdge -From 'Web' -To 'App' -HtmlEdgeLabel $HtmlLabel -HeadLabel 'eth0' -TailLabel 'eth1' -LabelDistance 2
    ...
    .EXAMPLE
        Add-NodeEdge -From 'NodeA' -To 'NodeB' -EdgeLabel 'Link' -EdgeLabelFontSize 10 -EdgeLabelFontColor 'blue' -TailPort 'e' -HeadPort 'w'
