function Add-InvertedTShapeLine {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        The Add-InvertedTShapeLine function generates an inverted T-shaped structure in a diagram by connecting four specified nodes:
    ...
    .EXAMPLE
        Add-InvertedTShapeLine -InvertedTStart "A" -InvertedTEnd "B" -InvertedTMiddleTop "C" -InvertedTMiddleDown "D" -LineColor "blue" -LineStyle "dashed"
