function Add-TShapeLine {
    ...
    .DESCRIPTION
        The Add-TShapeLine function creates a T-shaped (⊥) connector in a diagram by connecting four nodes:
    ...
    .EXAMPLE
        Add-TShapeLine -TShapeLeft "A" -TShapeRight "B" -TShapeMiddleUp "C" -TShapeMiddleDown "D" -LineStyle "dashed" -LineColor "blue"
