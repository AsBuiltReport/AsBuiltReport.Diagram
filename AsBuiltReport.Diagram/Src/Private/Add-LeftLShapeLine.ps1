function Add-LeftLShapeLine {
    ...
    .DESCRIPTION
        The Add-LeftLShapeLine function creates a left-facing L-shaped connector for use in diagram generation, such as with Graphviz.
    ...
    .EXAMPLE
        Add-LeftLShapeLine -LeftLShapeUp "StartNode" -LeftLShapeDown "EndNode" -LeftLShapeLeft "LeftNode" -LineColor "blue" -LineStyle "dashed"
