function Add-HtmlLabel {
    ...
    .EXAMPLE
        ...
        $IconDebug = $false
        Add-HtmlLabel -Label $MainGraphLabel -IconType $CustomLogo -IconDebug $IconDebug
    ...
    .PARAMETER ImageSizePercent
        Percentage to scale the icon (1-100). Default is 100. When less than 100, IconPath is required and Get-ImagePercent is used.
