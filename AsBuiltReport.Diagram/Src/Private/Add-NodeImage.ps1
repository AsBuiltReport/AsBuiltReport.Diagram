function Add-NodeImage {
    <#
    .SYNOPSIS
        Generates an HTML table for visualizing an image with customizable properties, such as border, style, and image size.

    .DESCRIPTION
        The Add-NodeImage function creates an HTML table to display an image, typically used for diagramming nodes.
    ...
    .EXAMPLE
        Add-NodeImage -Name "MyNode" -ImagesObj $Images -IconType "ServerWindows" -ImageSizePercent 50 -TableBorder 1 -TableBorderColor "#FF0000" -TableBorderStyle "Solid"
