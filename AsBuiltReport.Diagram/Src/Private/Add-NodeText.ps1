function Add-NodeText {
    <#
    .SYNOPSIS
        Generates an HTML representation of a text box for a diagram node.

    .DESCRIPTION
        The Add-NodeText function creates an HTML representation of a text box for a diagram node.
    ...
    .EXAMPLE
        Add-NodeText -Name "Server1" -TableBorder 2 -TableBorderColor "#FF0000" -TableBorderStyle "SOLID" -Text "This is a test text box." -FontColor "#0000FF" -FontSize 14 -FontBold $true -TableBackgroundColor "#FFFF00" -NodeObject
