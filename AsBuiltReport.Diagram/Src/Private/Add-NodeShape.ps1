function Add-NodeShape {
    ...
    .DESCRIPTION
        The Add-NodeShape function creates an Node with a specific shape and customizable attributes for diagramming purposes.
    ...
    .EXAMPLE
        Add-NodeShape -Name "MyNode" -ImagesObj $Images -IconType "ServerWindows" -ImageSizePercent 50 -TableBorder 1 -TableBorderColor "#FF0000" -TableBorderStyle "Solid"
