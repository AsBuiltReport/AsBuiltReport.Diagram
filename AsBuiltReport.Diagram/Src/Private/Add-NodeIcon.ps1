function Add-NodeIcon {
    ...
    .Example
        ...
        Add-NodeIcon -Name $DC -IconType "ForestRoot" -Align "Center" -Rows $DCRows
                    _________________
                    |               |
                    |      Icon     |
                    _________________
    ...
    .PARAMETER ImageSizePercent
        Sets the image size in percent (1-100). Default is 100. If less than 100, IconPath must be provided and Get-ImagePercent is used.
