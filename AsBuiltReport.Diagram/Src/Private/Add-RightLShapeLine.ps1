function Add-RightLShapeLine {
    ...
    .DESCRIPTION
        The Add-RightLShapeLine function creates a right-facing L-shaped connector for use in diagram generation.
    ...
    .EXAMPLE
        Add-RightLShapeLine -RightLShapeUp "A" -RightLShapeDown "B" -RightLShapeRight "C" -LineColor "blue" -LineStyle "dashed"
