function Add-InvertedLShapeLine {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        The Add-InvertedLShapeLine function creates an inverted L-shaped connector in a diagram by linking three nodes:
    ...
    .EXAMPLE
        Add-InvertedLShapeLine -InvertedLShapeUp "NodeA" -InvertedLShapeDown "NodeB" -InvertedLShapeRight "NodeC" -Arrowhead "normal" -LineStyle "dashed" -LineColor "blue"
