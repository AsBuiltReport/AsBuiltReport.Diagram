function Add-HorizontalLine {
    ...
    .DESCRIPTION
        The Add-HorizontalLine function generates a horizontal line between two specified nodes, allowing for extensive customization of the line's appearance.
    ...
    .EXAMPLE
        Add-HorizontalLine -HStart "NodeA" -HEnd "NodeB" -LineStyle "dashed" -LineColor "blue" -Arrowhead "normal"
