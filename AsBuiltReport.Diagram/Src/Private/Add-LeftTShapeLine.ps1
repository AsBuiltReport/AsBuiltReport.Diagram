function Add-LeftTShapeLine {
    ...
    .DESCRIPTION
        The Add-LeftTShapeLine function creates a Left T-shaped connector in a diagram by defining four nodes and connecting them with edges.
    ...
    .EXAMPLE
        Add-LeftTShapeLine -LeftTShapeUp "Top" -LeftTShapeDown "Bottom" -LeftTShapeMiddleRight "Right" -LeftTShapeMiddleLeft "Center" -LineColor "blue" -LineStyle "dashed"
