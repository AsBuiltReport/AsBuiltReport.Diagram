function Add-VerticalLine {
    ...
    .DESCRIPTION
        The Add-VerticalLine function creates a vertical line connecting two specified nodes within a diagram,
    ...
    .EXAMPLE
        Add-VerticalLine -VStart "NodeA" -VEnd "NodeB" -LineStyle "dashed" -LineColor "blue" -LineWidth 2

        Draws a dashed blue vertical line of width 2 between nodes "NodeA" and "NodeB".

    .EXAMPLE
        Add-VerticalLine -IconDebug $true
