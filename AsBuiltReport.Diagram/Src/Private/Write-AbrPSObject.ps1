function Write-AbrPSObject {
    ...
    .EXAMPLE
        ...
        Write-AbrPSObject -PSObject $psObjects -MatchMethod Exact -Column "*" -Value $False -RowForeColor Yellow -RowBackColor Blue;
    .EXAMPLE
        ...
        Write-AbrPSObject -PSObject $psObjects -MatchMethod Exact -Column "*" -Value $False -RowForeColor Red;
    .PARAMETER Object
        Alias: O, I
        Data Type: Object
        Mandatory: True
