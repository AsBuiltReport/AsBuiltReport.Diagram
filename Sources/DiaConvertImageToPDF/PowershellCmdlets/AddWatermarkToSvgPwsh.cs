...
{
    [Cmdlet(VerbsCommon.Add, "WatermarkToSvg")]
    public class AddWatermarkToSvgCommand : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteError(new ErrorRecord(new FileNotFoundException(string.Format("The specified SVG file '{0}' does not exist.", SourceSvgFilePath)), "FileNotFound", ErrorCategory.InvalidArgument, SourceSvgFilePath));
                return;
            }
